...
TRAIN_CLASSES               = "./model_data/students_body_language.txt"
TRAIN_ANNOT_PATH            = "./model_data/students_body_language_train.txt"
TRAIN_LOGDIR                = "log"
...
# TEST options
TEST_ANNOT_PATH             = "./model_data/students_body_language_test.txt"
TEST_BATCH_SIZE             = 2
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
